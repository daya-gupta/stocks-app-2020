            ...
            series: [{
                ...
                data: (function () {
                    ...
                    for (var i = 0; i <= _this.apiData.length; i += 1) {
                        if (_this.apiData[i]) {
                            ...
                            const callTotal = Number(_this.apiData[i].callTotal2);
                            data.push([
                                time,
                                callTotal,
                            ]);
                ...
                data: (function () {
                    ...
                    for (var i = 0; i <= _this.apiData.length; i += 1) {
                        if (_this.apiData[i]) {
                            const time = Number(_this.apiData[i].timestamp);
                            const putTotal = Number(_this.apiData[i].putTotal2);
                            data.push([
                                time,
                                putTotal,
                            ]);
                ...
                data: (function () {
                    ...
                    for (var i = 0; i <= _this.apiData.length; i += 1) {
                        if (_this.apiData[i]) {
                            const time = Number(_this.apiData[i].timestamp);
                            const putTotal = Number(_this.apiData[i].callTotal2) + Number(_this.apiData[i].putTotal2);
                            data.push([
                                time,
                                putTotal,
                            ]);
